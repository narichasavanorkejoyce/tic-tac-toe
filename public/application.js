...
/***/ function(module, exports, __webpack_require__) {
	...
	var uxLogic = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewGame = function onNewGame(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  gameApi.newGame(data).done(gameUi.successNewGame).fail(gameUi.fail);
	};
	...
	var onSubmitMove = function onSubmitMove(event) {
	  ...
	  gameApi.submitMove(data).done(gameUi.successMove).fail(gameUi.fail);
	};

	var onGetIndex = function onGetIndex(event) {
	  event.preventDefault();
	  // const data = getFormFields(event.target)
	  gameApi.indexGame().done(gameUi.successIndex).fail(gameUi.fail);
	};

	var gameEventHandlers = function gameEventHandlers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var successMove = function successMove(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkWinX = function checkWinX(object) {
	  var winsX = 0;
	...
	var checkWinO = function checkWinO(object) {
	  var winsO = 0;
	  // Loop through the games object
	  for (var i = 0; i < object.length; i++) {
	    // Check whether there is a winning combination
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameBoard = function gameBoard(event) {
	  var lengthArray = gameArray.filter(function (e) {
	    return e !== undefined;
	  }).length;
	...
	var checkWinX = function checkWinX() {
	  // Check whether there is a winning combination
	...
	var checkWinO = function checkWinO() {
	  // Check whether there is a winning combination
	...
	var checkDraw = function checkDraw(lengthArray) {
	...
	var gameLogicHandlers = function gameLogicHandlers() {
	  $('.new-game').on('submit', resetBoard);
	  $('.slot').on('click', gameBoard);
	};

	module.exports = {
	  gameLogicHandlers: gameLogicHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
